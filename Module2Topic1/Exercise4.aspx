...
<body>
    ...
    <form runat="server">
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="fullName" ErrorMessage="Required Name"></asp:RequiredFieldValidator><br /><br />
        ...
        <asp:RangeValidator runat="server" ControlToValidate="age" Type="Integer" MinimumValue="0" MaximumValue="100" ErrorMessage="Age must be between 0-100"></asp:RangeValidator><br /><br />
        ...
        <%-- Hint: https://www.tutorialspoint.com/asp.net/asp.net_validators.htm#:~:text=The%20RegularExpressionValidator%20allows --%>
         <asp:RegularExpressionValidator runat="server" ControlToValidate="email" ValidationExpression="^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,3})+$" ErrorMessage="Only valid email address." ></asp:RegularExpressionValidator><br /><br />
        ...
        <asp:CompareValidator runat="server" ControlToValidate="confirmEmail" ControlToCompare="email" Operator="Equal" Type="String" ErrorMessage="Not Matched."></asp:CompareValidator><br /><br />

        <asp:Button Text="Submit" runat="server" UseSubmitBehavior="true" OnClick="Unnamed5_Click" />
